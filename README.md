...
[Codeship](https://codeship.com) (completely Docker-based CI&CD workflow, replicate test&production environment locally, orchestrate CI environment with Docker Compose)
